...
class Text(Modality):
    def __init__(self, name, enc, dec, class_dim, style_dim, lhood_name, len_sequence, alphabet, plotImgSize, font):
    ...
    def plot_data(self, d):
        out = plot.text_to_pil(d.unsqueeze(0), self.plot_img_size, self.alphabet, self.font)
        return out
